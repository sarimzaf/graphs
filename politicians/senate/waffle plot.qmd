...
pacman::p_load(tidyverse, stringr, lubridate, extrafont, janitor, 
               scales, waffle, showtext, ggtext, sysfonts)
...
p <- ggplot(plot_data, aes(fill = generation, values = count)) +
    ...
    theme(
      ...
      legend.text = element_text(size = 12, family = myfont),
      # title + caption
      plot.title = element_markdown(size = 26, hjust = 0.5, 
                                    family = myfont,
                                    face = "bold", margin = margin(t = 2)),
      plot.subtitle = element_text(size = 13, hjust = 0.5, 
                                   family = myfont, color = "gray20", 
                                  margin = margin(t = 5)),
      plot.caption = element_text(size = 10, family = myfont, 
                                  margin = margin(t = 15), 
                                  color = "gray45"),
